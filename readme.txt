...
Name: Ragdoll Parkour

Release: 1.0

Requirements: LUA Plugin & ScriptHook

--------------------------------------------------------------------------------------------

<<INSTALLATION>>: Place the Lua file in the addins folder in the LUA plugin folder.
...
<<TIPS>>: Although I've enabled invincibility whilst holding the X key so you can perform safe landings, it never
